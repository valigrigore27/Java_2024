...
In clasa Bag am metoda public synchronized Token drawRandomToken() ce va face ca atunci cand playerii vor extrage token-uri din Bag, sa nu extraga in acelasi timp acelasi token.